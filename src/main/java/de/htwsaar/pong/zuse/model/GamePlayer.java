/*************************************************//**
 *  \brief     Kurzbeschreibung: Class GamePlayer
 *  \details   Übernimmt die Aufgaben des Spielers
...
public class GamePlayer extends Rectangle {
  ...
  public GamePlayer(boolean playerTwo) {
    ...
    if (playerTwo) { //Spieler 2
      ...
      this.setLayoutX(WIDTH - PLAYERWIDTH
          - 20); //20px Breite des Paddles + 20px Abstand zum Rand = 40px → 1280-40 = 1240
    } else { //Spieler 1
